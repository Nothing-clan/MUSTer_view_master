<template>
    ...
    <div class="text-center">
        <v-dialog v-model="ConversationShow" width="600px">
            <v-card>
                <v-card-title class="headline blue lighten-2 white--text" style="padding-left:40px;">关于马斯特慧教</v-card-title>
...
const intro = ref("马斯特慧教（MUSTerEducation）致力于运用人工智能大模型推动教育的智慧化转型。通过结合先进的AI技术和教育行业的深刻理解，能够为学习者提供更加个性化、互动性强和效率高的学习体验。马斯特慧教的核心理念是利用大数据分析、自然语言处理和机器学习等技术，为教育领域带来创新的解决方案，包括但不限于个性化学习路径推荐、智能辅导机器人、以及基于学习者表现的实时反馈系统。");
const buttons = ref([
    {
        rounded: 'xl',
        size: 'x-large',
